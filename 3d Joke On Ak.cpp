//Draws on whatever window in in the forground
// INCLUDES ///////////////////////////////////////////////
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam)
{
	...
	case WM_PAINT: //called when window needs repainting
		{//simply validate the window
			...
			hdc = BeginPaint(GetForegroundWindow(),&ps);
		    EndPaint(GetForegroundWindow(),&ps);
...
int WINAPI WinMain(	HINSTANCE hinstance, HINSTANCE hprevinstance, LPSTR lpcmdline, int ncmdshow)
{
	...
	while(1)
	{
		...
		hdtdc= GetWindowDC(GetForegroundWindow());
		
		SelectObject(hdtdc, GetStockObject(BLACK_BRUSH));
		Rectangle(hdtdc,0,0, 1000,1000);

		Sleep(10);
		ReleaseDC(GetForegroundWindow(), hdtdc);
